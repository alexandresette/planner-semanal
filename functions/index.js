...
<html lang="pt-BR">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Convite — Planner Semanal</title></head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0B1120;padding:40px 16px;">
    <tr><td align="center">
      <table width="100%" style="max-width:480px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:20px;overflow:hidden;">
        <tr><td style="background:linear-gradient(135deg,rgba(59,130,246,0.15),rgba(139,92,246,0.15));padding:32px 32px 24px;text-align:center;border-bottom:1px solid rgba(255,255,255,0.06);">
        ...
        <tr><td style="padding:28px 32px;">
          <p style="margin:0 0 16px;font-size:15px;color:#94A3B8;line-height:1.6;">Você recebeu um convite para acessar o <strong style="color:#F1F5F9;">Planner Semanal</strong>!</p>
          <p style="margin:0 0 24px;font-size:14px;color:#64748B;line-height:1.6;">Clique no botão abaixo para acessar o app. Na primeira vez, você poderá entrar com sua conta Google ou criar um usuário e senha.</p>
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td align="center" style="padding:4px 0 28px;">
              <a href="${appUrl}" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#3B82F6,#8B5CF6);color:#ffffff;font-size:15px;font-weight:700;text-decoration:none;border-radius:12px;">Acessar o Planner →</a>
            </td></tr>
          </table>
          <div style="background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.15);border-radius:12px;padding:16px 18px;">
            ...
            <p style="margin:0;font-size:13px;color:#94A3B8;line-height:1.6;">
              ...
              <strong style="color:#CBD5E1;">Com senha:</strong> o app vai pedir para criar usuário e senha no primeiro acesso.
            </p>
          </div>
        </td></tr>
        <tr><td style="padding:16px 32px 28px;border-top:1px solid rgba(255,255,255,0.05);text-align:center;">
      ...
      try {
        ...
        if (!response.ok) {
          ...
          res.status(500).json({ error: "Falha ao enviar e-mail via Resend." }); return;
        }
